...
- cs2881r
---
# Qwen2.5-3B-Instruct-Sheldon-SFT-touchup-v4 (merged bf16 weights)
...
Files: merged bf16 safetensors + tokenizer, loadable with `AutoModelForCausalLM.from_pretrained` or vLLM.
...
`tbooy/Qwen2.5-3B-Instruct-Sheldon-SFT-touchup-v4-LoRA (adapter + checkpoints)` and the RLAIF model `tbooy/Qwen2.5-3B-Instruct-Sheldon-RLAIF-grpo-v2`.
