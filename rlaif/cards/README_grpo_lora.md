...
- cs2881r
---
# Qwen2.5-3B-Instruct-Sheldon-RLAIF-grpo-v2 (LoRA adapter + checkpoints)
...
Files: `final_adapter/` (PEFT LoRA on the touch-up model, step 109) and `checkpoint-{25,50,75,100,109}/` with trainer states (per-step reward components under `sheldon/`). Apply to `tbooy/Qwen2.5-3B-Instruct-Sheldon-SFT-touchup-v4`.
...
`tbooy/Qwen2.5-3B-Instruct-Sheldon-RLAIF-grpo-v2 (merged weights)`.
